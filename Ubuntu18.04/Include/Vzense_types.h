...
typedef struct
{
	uint16_t    gmmgain1;      //!< The gmmgain of the first range.
	uint16_t    gmmgain2;      //!< The gmmgain of the second range.
	uint16_t    gmmgain3;      //!< The gmmgain of the third range.
	uint8_t	    option;
}PsWDRGMMGain;
/**
* @brief WDR (Wide Dynamic Range) output mode settings (e.g. Near/Far range fusion).
...
typedef struct
{
	uint16_t    threshold1;      //!< The threshold of the first range.
	uint16_t    threshold2;      //!< The threshold of the second range.
	uint16_t    threshold3;      //!< The threshold of the third range.
	uint8_t	    option;
}PsWDRThreshold;
