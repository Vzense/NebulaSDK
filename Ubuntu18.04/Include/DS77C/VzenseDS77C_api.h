#ifndef VZENSEDS77C_API_H
#define VZENSEDS77C_API_H

/**
* @file VzenseDS77C_api.h
* @brief VzenseDS77C API header file.
* Copyright (c) 2019-2022 Vzense Interactive, Inc.
*/

/*! \mainpage VzenseDS77C API Documentation
*
* \section intro_sec Introduction
*
* Welcome to the VzenseDS77C API documentation. This documentation enables you to quickly get started in your development efforts to programmatically interact with the Vzense CW TOF Camera (eg:DS77C).
*/
