...
/**
* @brief         Returns the image data for the current frame from the device specified by <code>device</code>. Before invoking this API, invoke PsReadNextFrame() to capture one image frame from the device.
...
* @return       ::PsRetOK   if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetWorkModeStatus(PsDeviceHandle device, PsWorkModeStatus status);
...
* @return        ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetConfidenceFilterParams(PsDeviceHandle device, PsConfidenceFilterParams params);
...
* @return        ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_GetConfidenceFilterParams(PsDeviceHandle device, PsConfidenceFilterParams *pParams);
...
* @return       ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetFlyingPixelFilterParams(PsDeviceHandle device, const PsFlyingPixelFilterParams params);
...
* @return        ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_GetFlyingPixelFilterParams(PsDeviceHandle device, PsFlyingPixelFilterParams* params);
...
* @return       ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetFillHoleFilterParams(PsDeviceHandle device, const PsFillHoleFilterParams params);
...
* @return        ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_GetFillHoleFilterParams(PsDeviceHandle device, PsFillHoleFilterParams* params);
...
* @return       ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetSpatialFilterParams(PsDeviceHandle device, const PsSpatialFilterParams params);
...
* @return        ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_GetSpatialFilterParams(PsDeviceHandle device, PsSpatialFilterParams* params);
...
* @return       ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetOverexposureFilterParams(PsDeviceHandle device, const PsOverexposureFilterParams params);
...
* @return        ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_GetOverexposureFilterParams(PsDeviceHandle device, PsOverexposureFilterParams* params);
...
* @param[in]    pUserData    Pointer to the user data. See ::PtrUpgradeStatusCallback
* @return       ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetUpgradeStatusCallback(PsDeviceHandle device, PtrUpgradeStatusCallback pCallback, const void* pUserData);
...
* @return       ::PsRetOK    if the function succeeded, or one of the error values defined by ::PsReturnStatus.
*/
VZENSE_C_API_EXPORT PsReturnStatus VZCT_SetHotPlugStatusCallback(PtrHotPlugStatusCallback pCallback, const void* pUserData);
